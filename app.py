...
# Ensure that the language_tool_python server URL is correct and running
my_tool = language_tool_python.LanguageTool('en-US', url='http://127.0.0.1:8081/v2/')
...
def percentage_of_corrections(extracted_text):
  ...
  headers = {'Content-Type': 'application/x-www-form-urlencoded', 'Ocp-Apim-Subscription-Key': api_key_textcorrection}
...
@cross_origin()  # Allow requests from all origins
def submit_text():
